    ...
    <section id="experience" className="py-32 px-6 md:px-12 lg:px-24 bg-surface/20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          >
            From understanding fundamentals to building real-world projects, this journey reflects my continuous effort to grow as a developer.
          </motion.p>
          ...
          >
            <div className="relative z-10">
              <span className="block text-4xl font-black text-accent font-headline">Still Learning</span>
              <span className="font-mono text-[10px] text-text-dim uppercase tracking-widest font-bold">Every Day</span>
            </div>
